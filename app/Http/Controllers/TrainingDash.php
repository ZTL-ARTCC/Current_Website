...
class TrainingDash extends Controller {
    ...
    public function handleSchedule() {
        ...
        if (!$user->onboarding_complete) {
            return redirect()->back()->with('error', 'VATUSA ATC Basic Exam and ZTL Onboarding must be complete before scheduling a training session. Please refer to the appropriate courses on VATUSA before continuing. Contact the TA at ta@ztlartcc.org with questions or concerns.');
        }
