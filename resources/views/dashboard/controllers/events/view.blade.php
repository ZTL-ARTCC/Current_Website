                                        ...
                                        <div class="modal fade" id="addrequest{{ $r->id }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    {{ html()->form()->route('AdminDash@assignPosition', [$r->id]) }}
                                                    @csrf
                                                    <div class="modal-body">
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    @if($positions->count() > 0)
                            {{ html()->form()->route('ControllerDash@signupForEvent') }}
                            @csrf
                        ...
                        @if(Auth::user()->isAbleTo('events'))
                            <br>
                            {{ html()->form()->route('AdminDash@addPosition', [$event->id]) }}
                            @csrf
                            <div class="row">
                                <div class="col-sm-10">
		...
		<div class="modal fade" id="manualAssign" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
                    ...
                    {{ html()->form()->route('AdminDash@manualAssign', [$event->id]) }}
    				@csrf
					<div class="modal-body">
						<div class="form-group">
							<div class="row">
