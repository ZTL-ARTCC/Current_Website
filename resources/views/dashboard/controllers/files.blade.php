                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(Auth::user()->can('files'))
										...
										<a onclick="itemReorder({{ $f->id }},{{ $loop->index }},'up');" class="btn btn-info simple-tooltip" data-toggle="tooltip" title="Up"><i class="fas fa-arrow-up"></i></a>
										<a onclick="itemReorder({{ $f->id }},{{ $loop->index }},'up');" class="btn btn-info simple-tooltip" data-toggle="tooltip" title="Down"><i class="fas fa-arrow-down"></i></a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
