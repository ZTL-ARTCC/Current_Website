    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                @csrf
                <div class="row">
                    <div class="col-5"><b>TS3 UID: <a style="color:inherit" href="#" data-toggle="tooltip"
                                                      title="In TeamSpeak 3, go to Tools->Identities. Paste your 'Unique ID' here for bot integration"><i
                                        class="fas fa-info-circle"></i></a></b></div>
                    <div class="col-7"><p>{!! Form::text('ts3', Auth::user()->ts3, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="row">
