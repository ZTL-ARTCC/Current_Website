...
-->
                ...
                <center><div style="font-family:heartbit; font-size:20px; margin-bottom:0px; padding-bottom:0px;"><?php echo strtoupper(gmdate("D m/d/Y", time())); ?></div><div style="font-family:heartbit; font-size:56px; font-weight:bold">71:10:65</div></center>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card card-body" style="background-color:lightgrey">
