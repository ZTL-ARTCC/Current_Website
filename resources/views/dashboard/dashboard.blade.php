...
-->
                ...
                <center><span style="font-family:heartbit; font-size:24px"><?php echo gmdate("m/d/Y", time()); ?></span><span style="font-family:heartbit; font-size:48px; font-weight:bold">71:10:65</span></center>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card card-body" style="background-color:lightgrey">
