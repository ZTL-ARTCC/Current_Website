    ...
    <div class="container">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="new">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($new as $v)
                            <tr class="text-center">
                                ...
                                <td>{{ $v->updated_at }}</td>
                                <td>
                                    <a href="/dashboard/admin/roster/visit/accept/{{ $v->id }}" class="btn btn-success simple-tooltip" data-toggle="tooltip" title="Accept"><i
                                                class="fa fa-check"></i></a>
                                    <span data-toggle="modal" data-target="#reject{{ $v->id }}">
                                        <button type="button" class="btn btn-danger simple-tooltip" data-placement="top" data-toggle="tooltip" title="Reject"><i
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <label for="reject_reason">Please specific why the visit request is being rejected. This will be sent to the requesting visitor
                                                with a rejection notification.</label>
                ...
                @else
                    @include('inc.empty_state', ['header' => 'No New Visit Requests', 'body' => 'There are no new visit requests at this time.', 'icon' => 'fa-solid
                    fa-suitcase'])
                @endif
            </div>
            <div role="tabpanel" class="tab-pane" id="accepted">
                ...
                @else
                    @include('inc.empty_state', ['header' => 'No Accepted Visit Requests', 'body' => 'There are no previously accepted visit
                    requests at this
                    time.',
                    'icon' =>
            ...
            <div role="tabpanel" class="tab-pane" id="rejected">
                ...
                @else
                    @include('inc.empty_state', ['header' => 'No Rejected Visit Requests', 'body' => 'There are no previously rejected visit
                    requests at this
                    time.',
                    'icon' =>
                    'fa-solid fa-suitcase'])
