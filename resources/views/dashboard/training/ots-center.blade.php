                        ...
                        @foreach($ots_new as $o)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dashboard/training/tickets?id{{ $user->id }}" class="btn btn-success simple-tooltip" data-toggle="tooltip" title="View Training Tickets."><i class="fas fa-check"></i></a>
