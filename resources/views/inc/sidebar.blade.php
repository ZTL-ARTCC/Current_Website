    ...
    <div class="nav flex-column nav-pills sidebar-container" role="tablist" aria-orientation="vertical">
        ...
        @if(Auth::user()->canTrain == 1 || Auth::user()->isAbleTo('train'))
            ...
            <div class="content">
                ...
                <a class="nav-link {{ Nav::urlDoesContain('/dashboard/training/trainer_feedback') }}" href="/dashboard/training/trainer_feedback">Leave Trainer Feedback</a>
                @if(Auth::user()->isAbleTo('train'))
                    ...
                    @if(Auth::user()->hasRole('ata') || Auth::user()->isAbleTo('snrStaff'))
                        ...
                        <a class="nav-link {{ Nav::urlDoesContain('/dashboard/admin/trainer_feedback') }}" href="/dashboard/admin/trainer_feedback">Manage Trainer Feedback</a>
                    @endif
                @endif
            </div>
        @endif
