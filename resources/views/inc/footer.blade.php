<footer id="myFooter" class="bg-darker-themed">
    <div class="footer-social bg-darker-themed">
    ...
    <div class="container">
        <p><a class="text-themed" href="https://www.ztlartcc.org/privacy" target="_blank">Privacy Policy, Terms and Conditions</a></p>
