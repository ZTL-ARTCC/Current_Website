<footer id="myFooter" class="bg-secondary">
    <div class="container bg-secondary">
        <div id="partnerContainer" class="footer-social bg-secondary">
            ...
            <a id="teamspeak_logo" href="https://www.teamspeak.com/?tour=yes" target="_blank"><img src="{{ Vite::asset('resources/assets/img/footer/partner-ts.png') }}" class="m-2" alt="TeamSpeak"></a><a href="https://www.thepilotclub.org/" target="_blank"><img src="{{ Vite::asset('resources/assets/img/footer/partner-tpc.png') }}" class="m-2" alt="The Pilot Club"></a>
        </div>
		...
		<p class="px-5">vZTL is an affiliate of the <a href="http://www.vatsim.net" target="_blank"><img src="{{ Vite::asset('resources/assets/img/footer/vatsim_logo.png') }}" class="vatsim_logo" alt="VATSIM"></a> network and the <a href="http://www.vatusa.net" target="_blank"><img src="{{ Vite::asset('resources/assets/img/footer/vatusa_logo.png') }}" class="vatusa_logo" alt="VATUSA"></a> division</p>
