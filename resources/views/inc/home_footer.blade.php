<footer id="myFooter" class="bg-secondary">
    <div class="container bg-secondary">
        <div id="partnerContainer" class="footer-social bg-secondary">
            ...
            <a id="teamspeak_logo" href="https://www.teamspeak.com/?tour=yes" target="_blank"><img src="{{ Vite::image('footer/partner-ts.png') }}" class="m-2" alt="TeamSpeak"></a><a href="https://www.thepilotclub.org/" target="_blank"><img src="{{ Vite::image('footer/partner-tpc.png') }}" class="m-2" alt="The Pilot Club"></a>
        </div>
