        ...
        <a class="navbar-brand" href="/dashboard">
            @toggle("custom_theme_logo")
                ...
                @if(($month == 12 && $day == 31) || ($month == 1 && $day == 1))
                    <img src="/photos/logos/ztl_logo_fireworks-black.png">
                @elseif(($month >= 3 && $day >= 20) && $month <= 4)
                    <img src="/photos/logos/ztl_logo_spring-black.png">
                @elseif(($month == 1 && $day == 16) || ($month == 2 && $day == 20) || ($month == 5 && $day == 29) || ($month == 6 && $day == 19) || ($month == 7 && $day == 4) || ($month == 9 && $day == 4) || ($month == 10 && $day == 10))
                    <img src="/photos/logos/ztl_logo_flag-black.png">
                @elseif($month >= 6 && $month <= 9)
                    <img src="/photos/logos/ztl__logo_beach-black.png">
                @elseif($month == 10)
                    <img src="/photos/logos/ztl_logo_halloween-black.png">
                @elseif($month == 11 && $day >= 20)
                    <img src="/photos/logos/ztl_logo_turkey-black.png">
                @elseif($month == 12)
                    <img src="/photos/logos/ztl_logo_santa-black.png">
                @else
                    <img src="/photos/logos/0_ztl_logo_black.png">
                @endif
            @else
                <img src="/photos/logos/0_ztl_logo_black.png">
            @endtoggle
