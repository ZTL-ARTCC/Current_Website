<html>
    <head>
        ...
        <style>
            body {
                background-image: url('{{ Vite::asset('resources/assets/img/pilot_passport/certificate_background.jpg') }}');
    ...
    <body>
        ...
        <div class="medal-block">
            <img src="{{ Vite::asset('resources/assets/img/pilot_passport/challenge_medal.png') }}" height="300px">
        </div>
