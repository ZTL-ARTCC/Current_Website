...
<p>This email is automated. If you believe you have received this email in error, please contact the ZTL Webmaster at <a href="mailto:{{config('artcc.email_wm')}}">{{config('artcc.email_wm')}}</a>.</p>
<br>
