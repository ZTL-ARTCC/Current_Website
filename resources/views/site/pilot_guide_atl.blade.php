...
<div class="container">
    ...
    <div class="tab-content">
        <div id="tab0" class="tab-pane active">
            <img class="float-end m-1" src="{{ Vite::image('pilot_guide/pg_atl_tab0.png') }}">
            <h3>Welcome</h3>
        ...
        <div id="tab3" class="tab-pane fade">
            <img class="float-end m-1" src="{{ Vite::image('pilot_guide/pg_atl_tab3.png') }}">
        ...
        <div id="tab4" class="tab-pane fade">
            <div id="diagram1Carousel" class="carousel slide w-25 float-end">
                <br />
                <a href="{{ $aaup }}" target="_blank"><img src="{{ Vite::image('pilot_guide/atl_aaup.png') }}" class="d-block w-100" alt="AAUP"></a>
            </div>
        ...
        <div id="tab5" class="tab-pane fade">
            <img class="float-end m-1" src="{{ Vite::image('pilot_guide/pg_atl_tab5.png') }}">
            <h3>Push & Start</h3>
        ...
        <div id="tab6" class="tab-pane fade">
            <img class="float-end m-1" src="{{ Vite::image('pilot_guide/pg_atl_tab6.png') }}">
            <h3>Taxi</h3>
            ...
            <div id="diagram2Carousel" class="carousel slide w-25 float-end" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a href="{{ $diag }}" target="_blank"><img src="{{ Vite::image('pilot_guide/atl_diag.png') }}" class="d-block w-100" alt="Diagram"></a>
                    </div>
        ...
        <div id="tab7" class="tab-pane fade">
            <img class="float-end m-1" src="{{ Vite::image('pilot_guide/pg_atl_tab7.png') }}">
        ...
        <div id="tab8" class="tab-pane fade">
            <img class="float-end m-1" src="{{ Vite::image('pilot_guide/pg_atl_tab8.png') }}">
            <h3>Arrival</h3>
