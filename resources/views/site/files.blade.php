                    ...
                    @if($vrc->count() > 0)
                        @foreach($vrc as $f)
                            <tr>
                                ...
                                <td>
								<div class="btn-group">
                                    <a href="{{ $f->path }}" download="{{ $f->path }}" target="_blank" class="btn btn-success btn-block simple-tooltip" data-toggle="tooltip" title="Download"><i class="fas fa-download"></i></a>
