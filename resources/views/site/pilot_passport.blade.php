        ...
        <div role="tabpanel" class="tab-pane p-2 mb-4{{ $active }}" id="information" dusk="info">
            <div class="row">
                ...
                <div class="col-sm-4 text-center">
                    <img src="{{ Vite::asset('resources/assets/img/pilot_passport/pilot_passport_stamp.png') }}" width="200px" alt="stamp">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
            ...
            @foreach($enrollments as $enrollment)
                ...
                @foreach($enrollment->airfields as $a)
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        @else
                            <img src="{{ Vite::asset('resources/assets/img/pilot_passport/pilot_passport_stamp_gray.png') }}" width="150px" alt="stamp">
                            <br>No visit logged
                        @endif
                    </div>
