    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_atm')}}" ><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_datm')}}" ><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_ta')}}" ><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_wm')}}" ><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_ec')}}" ><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_fe')}}" ><i class="fa fa-envelope" ></i></a>
        </h4>
