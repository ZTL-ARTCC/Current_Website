    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_atm')}}" style="color:black"><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_datm')}}" style="color:black"><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_ta')}}" style="color:black"><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_wm')}}" style="color:black"><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_ec')}}" style="color:black"><i class="fa fa-envelope" ></i></a>
        </h4>
    ...
    <div class="block-heading-two">
        <h4>
            ...
            @else
                ...
                @endforeach
            @endif
            &nbsp;<a href="mailto:{{config('artcc.email_fe')}}" style="color:black"><i class="fa fa-envelope" ></i></a>
        </h4>
