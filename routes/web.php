...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        Route::prefix('announcement')->middleware('role_or_permission:staff|marketing')->group(function () {
        ...
        Route::prefix('calendar')->middleware('role_or_permission:staff|marketing')->group(function () {
